...
class MainScreenController:
    ...
    def add_file(self):
        ...
        self.view.file_manager.select_dir = False
        self.view.file_manager.selector = 'file'

    def add_folder(self):
        self.view.file_manager.show('/')
        self.view.file_manager.select_dir = True
        self.view.file_manager.selector = 'folder'
    ...
    def save_image(self):
        if self.image_processor and self.original_image_path:
    ...
    def update_displayed_image(self, image):
        self.image_processor.save_image(self.temp_image_path)
        self.view.update_image_source(self.temp_image_path)
